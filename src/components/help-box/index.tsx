...
export const HelpBox: React.FC = () => {
  ...
  const tenantRoles: string[] = ['System Administrator', 'Data Analyst', 'Machine Operator', 'IT Specialist'];
  const addOns: string[] = ['notifications', 'file'];
  const applicationName = `IIOT Application`;
