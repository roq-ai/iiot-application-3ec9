...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-administrator', 'data-analyst', 'machine-operator', 'it-specialist'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    {
      name: 'Edge Computing',
      path: '/edge-computings',
      entity: 'edge_computing',
      service: AccessServiceEnum.PROJECT,
      icon: FiCloud,
    },
    { name: 'Machine', path: '/machines', entity: 'machine', service: AccessServiceEnum.PROJECT, icon: FiCpu },
